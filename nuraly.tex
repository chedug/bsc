...
\]
By expanding to get a quadratic expression in $\alpha$ and $\beta$, we can derive values of $\alpha$ and $\beta$ that minimize the objective function $Q$ (these minimizing values are denoted $\hat{\alpha}$ and $\hat{\beta}$):[6]
